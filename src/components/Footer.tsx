...
export default function Footer({
  ...
  return (
    <footer className="bg-brand text-brand-beige/80">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-16 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_1fr_1fr_1fr] gap-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-5">
              <div className="w-10 h-10 bg-gradient-to-br from-brand-maroon to-brand-burgundy rounded-full flex items-center justify-center shadow">
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="rounded-2xl border border-white/10 overflow-hidden min-h-[200px] bg-white/5">
            <iframe
