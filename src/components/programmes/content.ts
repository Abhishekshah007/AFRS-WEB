...
export { educationProgrammesForHub, trainingOptionsForHub } from '@/components/programmes/catalog'
...
export const defaultHubEvents: HubEventCard[] = [
  ...
  {
    id: 'e3',
    slug: 'faculty-toxicology-fdp',
    title: 'Faculty Development Programme on Toxicology',
...
export const defaultArchive: ArchiveItem[] = [
  { label: 'National Events', count: '12 Nos', href: archiveFilterLinks['National Events'] },
  { label: 'International Events', count: '08 Nos', href: archiveFilterLinks['International Events'] },
  { label: 'Workshops', count: '24 Nos', href: archiveFilterLinks.Workshops },
  { label: 'Webinars', count: '18 Nos', href: archiveFilterLinks.Webinars },
]
...
export const tagToneClass: Record<'blue' | 'green' | 'purple' | 'orange', string> = {
