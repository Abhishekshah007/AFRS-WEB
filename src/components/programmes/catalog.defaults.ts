import type { EducationCategory, TrainingCategory, ArchiveFilterLinks } from '@/components/programmes/catalog'
...
export const defaultEducationCategories: EducationCategory[] = [
  {
    ...
    programmes: [
      { id: 'to-1', title: 'Introduction to Forensic Science (Online)', description: 'Foundational modules covering crime scene basics, evidence types, and legal procedure.', duration: '6 weeks', mode: 'Online', level: 'Beginner' },
      { id: 'to-2', title: 'Digital Evidence Handling — Remote Lab', description: 'Virtual lab exercises for imaging, hashing, and chain-of-custody documentation.', duration: '8 weeks', mode: 'Online', level: 'Intermediate' },
      { id: 'to-3', title: 'Document Examination — Online Cohort', description: 'Handwriting comparison, ink analysis theory, and case study reviews with faculty Q&A.', duration: '10 weeks', mode: 'Online', level: 'Intermediate' },
      { id: 'to-4', title: 'Forensic Report Writing Masterclass', description: 'Structured reporting for courts and agencies with peer-reviewed assignments.', duration: '4 weeks', mode: 'Online', level: 'All levels' },
    ],
  },
  {
    ...
    programmes: [
      { id: 'fp-1', title: 'Professional Diploma in Forensic Investigation', description: 'End-to-end investigation workflow from scene to courtroom testimony.', duration: '12 months', mode: 'Hybrid', level: 'Advanced' },
      { id: 'fp-2', title: 'Advanced Crime Scene Management', description: 'Complex scene documentation, team coordination, and multi-agency protocols.', duration: '3 months', mode: 'On-site', level: 'Advanced' },
      { id: 'fp-3', title: 'Laboratory Quality & Accreditation Prep', description: 'ISO-aligned practices for forensic laboratories and audit readiness.', duration: '6 weeks', mode: 'Hybrid', level: 'Professional' },
    ],
  },
  {
    ...
    programmes: [
      { id: 'cp-1', title: 'Certificate in Forensic Document Examination', description: 'Handwriting, typeface, ink analysis, and alteration detection.', duration: '3 months', mode: 'Hybrid', level: 'Beginner' },
      { id: 'cp-2', title: 'Certificate in Digital Forensics', description: 'Mobile imaging, network forensics, and legal aspects of digital evidence.', duration: '3 months', mode: 'Online', level: 'Intermediate' },
      { id: 'cp-3', title: 'Certificate in Forensic Ballistics', description: 'Firearm identification, wound patterns, and trajectory reconstruction.', duration: '2 months', mode: 'On-site', level: 'Intermediate' },
    ],
  },
  {
    ...
    programmes: [
      { id: 'ws-1', title: 'Crime Scene Photography Workshop', description: 'Lighting, scale placement, and admissible photographic documentation.', duration: '2 days', mode: 'On-site' },
      { id: 'ws-2', title: 'Toxicology Sample Collection Workshop', description: 'Sampling protocols, preservation, and transport for toxicological analysis.', duration: '1 day', mode: 'On-site' },
      { id: 'ws-3', title: 'Expert Witness Testimony Workshop', description: 'Courtroom presentation skills and cross-examination preparation.', duration: '3 days', mode: 'Hybrid' },
    ],
  },
]
...
export const defaultArchiveFilterLinks: ArchiveFilterLinks = {
  nationalEvents: '/courses/events?nature=national',
  internationalEvents: '/courses/events?nature=international',
