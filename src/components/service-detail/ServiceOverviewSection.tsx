...
export function ServiceOverviewSection({
  ...
  paragraphs,
  imageUrl,
  imageAlt = 'Forensic professional at work',
  ...
  return (
    ...
    >
      <div className={serviceDetailTokens.container}>
        <AnimateOnScroll>
          <div
            className={`grid items-center gap-8 md:gap-12 lg:gap-16 ${hasImage ? 'md:grid-cols-2' : ''}`}
          >
            <div>
            ...
            {hasImage && (
              <div className="relative">
                ...
                >
                  ...
                  <div>
                    <p className="text-sm font-bold text-[var(--svc-text)]">
