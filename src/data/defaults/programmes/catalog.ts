...
export const defaultEducationCategories: EducationCategory[] = [
    ...
    programmes: [
      {
        ...
        description:
          'Foundational modules covering crime scene basics, evidence types, and legal procedure.',
        duration: '6 weeks',
        mode: 'Online',
        level: 'Beginner',
      },
      {
        ...
        description:
          'Virtual lab exercises for imaging, hashing, and chain-of-custody documentation.',
        duration: '8 weeks',
        mode: 'Online',
        level: 'Intermediate',
      },
      {
        ...
        description:
          'Handwriting comparison, ink analysis theory, and case study reviews with faculty Q&A.',
        duration: '10 weeks',
        mode: 'Online',
        level: 'Intermediate',
      },
  ...
  },
  {
    ...
    icon: 'Award',
    title: 'Professional and Foundation Courses',
  ...
  },
  {
    ...
    icon: 'Timer',
    title: 'Capsule Training Program',
  ...
  },
  {
    ...
    icon: 'BookOpen',
    title: 'Research and Project Workshops',
...
export const defaultTrainingCategories: TrainingCategory[] = [
  ...
  },
  {
    ...
    summary: 'Full immersion program',
    tag: 'On-site',
    tagTone: 'green',
    programmes: [
      {
  ...
  },
  {
    ...
    summary: 'Innovative forensic studies',
    tag: 'Academic',
    tagTone: 'orange',
    programmes: [
      {
