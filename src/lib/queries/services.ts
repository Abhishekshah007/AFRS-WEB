...
function buildServicesContent(cms?: ServicesPage['sectionText']): ServicesPageContent {
  ...
  return {
    ...
    infrastructureBody3: defaults.infrastructureBody3,
    infrastructureBody4: defaults.infrastructureBody4,
    infrastructureBody5: defaults.infrastructureBody5,
    infrastructureBody6: defaults.infrastructureBody6,
